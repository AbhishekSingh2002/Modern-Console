...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/U_I/select";
...
export function NewsWidget() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 p-4">
      <Card className="w-full max-w-2xl bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 shadow-lg rounded-lg">
        <CardHeader>
        ...
        <CardContent>
          <Select onValueChange={setCategory} value={category}>
            <SelectTrigger className="bg-gray-200 dark:bg-gray-700 border-input text-foreground mb-4">
          ...
          <AnimatePresence>
            {displayedNews.map((article, index) => (
              ...
              >
                <Card
                  className="mt-4 cursor-pointer hover:bg-accent dark:hover:bg-gray-700 transition-colors duration-300"
